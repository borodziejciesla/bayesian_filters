...
#ifndef COMPONENTS_FILTERS_CORE_EXTENDED_KALMAN_FILTER_HPP_
#define COMPONENTS_FILTERS_CORE_EXTENDED_KALMAN_FILTER_HPP_
...
#endif  //  COMPONENTS_FILTERS_CORE_EXTENDED_KALMAN_FILTER_HPP_
